...
export const Features = () => {
    return (
        <section className=' w-full  nature-bg-space pt-24 relative ' id="features" data-aos="fade-up" data-aos-delay="300"
            data-aos-duration="2000"
            data-aos-easing="ease-in-out">
            <div className="grid lg:grid-cols-2 grid-cols-1 justify-between items-center   lg:pt-8 mx-8 xl:mx-36">
                <div className='md:text-4xl text-2xl py-2' data-aos="fade-up" data-aos-delay="350"
            data-aos-duration="1000"
            data-aos-easing="ease-in-out">
                    Discover<br></br> Yourself in <br></br>Nature's Embrace

                </div>
                <div className='bg-white w-full  h-[auto] px-6 py-16 text-neutral-600' data-aos="fade-up" data-aos-delay="400"
            data-aos-duration="1000"
            data-aos-easing="ease-in-out">
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 justify-between pt-8 lg:pt-0 pb-8 mx-8 xl:mx-36 items-center" data-aos="fade-up" data-aos-delay="450"
            data-aos-duration="1000"
            data-aos-easing="ease-in-out">
                <div className='md:text-4xl block lg:hidden text-2xl py-2'>Trips, <br></br> Events in <br></br> the Wild</div>
                <div className='bg-neutral-900 opacity-2  w-full  h-[auto] px-6 py-16 text-white' data-aos="fade-up" data-aos-delay="500"
            data-aos-duration="1000"
            data-aos-easing="ease-in-out">
            ...
            <div className=" mt-12 py-8 border-white border-t-4  bg-white md:bg-transparent text-black md:text-white" data-aos="fade-up" data-aos-delay="550"
            data-aos-duration="1000"
            data-aos-easing="ease-in-out">
